 ...
 */
final class Version20250221213833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande ADD type_demande VARCHAR(255) NOT NULL, DROP montant_demande, DROP type_song_demader, DROP photo_demande, CHANGE created_at created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('DROP INDEX IDX_31E581A06D8F00D ON donation');
        $this->addSql('ALTER TABLE donation ADD demande_id INT DEFAULT NULL, ADD description VARCHAR(255) DEFAULT NULL, DROP type_donation_id, DROP created_at, DROP updated_at, CHANGE description_donation type_de_donation VARCHAR(255) NOT NULL, CHANGE montant_donation montant DOUBLE PRECISION DEFAULT NULL, CHANGE photo_donation photo_materiel VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande ADD montant_demande DOUBLE PRECISION DEFAULT NULL, ADD type_song_demader VARCHAR(255) DEFAULT NULL, ADD photo_demande VARCHAR(255) DEFAULT NULL, DROP type_demande, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE donation ADD type_donation_id INT NOT NULL, ADD photo_donation VARCHAR(255) DEFAULT NULL, ADD created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', DROP demande_id, DROP photo_materiel, DROP description, CHANGE type_de_donation description_donation VARCHAR(255) NOT NULL, CHANGE montant montant_donation DOUBLE PRECISION DEFAULT NULL');
